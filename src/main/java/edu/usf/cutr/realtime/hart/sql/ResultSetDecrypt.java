...
public class ResultSetDecrypt {
	...
	public ArrayList<TransitData> decrypt(){
		ArrayList<TransitData> transitData = new ArrayList<TransitData>();
		try {
			while(rs.next()){
				TransitData td = convertRowToTransitData();
			    if(td!=null)
			        transitData.add(td);
			}
		} catch (SQLException e) {
	...
	public TransitData convertRowToTransitData() {
